...
export const es = {
  ...
  draftStripIn: 'en {n} temporadas',
  draftTierLottery: 'lotería',
  draftTierFirstRound: 'mitad de 1ª ronda',
  ...
  draftOutlookTiming: 'El draft te llega en {n} temporadas, a más tardar a los 22.',
  ...
  draftOutlookLimiterAbility: 'Tu fama ya se adelantó a tu nivel de juego.',
...
export const en: Dictionary = {
  ...
  draftOutlookTiming: 'The draft reaches you in {n} seasons, 22 at the latest.',
  ...
  draftOutlookLimiterAbility: 'Your reputation has outrun your game.',
