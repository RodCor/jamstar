...
export const PLAY_STYLES: PlayStyle[] = [
  {
    ...
    bonus: { shooting: 8, handling: 3, defense: -3, leadership: -1 },
    scoringBias: 1.18,
    playmakingBias: 0.92,
    defenseBias: 0.9,
    injuryFactor: 1.0,
  ...
  },
  {
    ...
    bonus: { handling: 8, iq: 6, leadership: 5, shooting: -2 },
    scoringBias: 0.86,
    playmakingBias: 1.32,
    defenseBias: 1.0,
    injuryFactor: 0.92,
  ...
  },
  {
    ...
    bonus: { shooting: 10, iq: 3, athleticism: -4, strength: -3 },
    scoringBias: 1.06,
    playmakingBias: 0.9,
    defenseBias: 0.88,
    injuryFactor: 0.82,
  ...
  },
  {
    ...
    bonus: { defense: 10, strength: 5, iq: 3, shooting: -5 },
    scoringBias: 0.78,
    playmakingBias: 0.94,
    defenseBias: 1.4,
    injuryFactor: 0.95,
  ...
  },
  {
    ...
    bonus: { athleticism: 11, strength: 4, iq: -4, shooting: -3 },
    scoringBias: 1.1,
    playmakingBias: 0.95,
    defenseBias: 1.08,
    injuryFactor: 1.45,
  ...
  },
  {
    ...
    bonus: { shooting: 3, handling: 3, defense: 3, iq: 3, leadership: 3, strength: 2 },
    scoringBias: 1.0,
    playmakingBias: 1.06,
    defenseBias: 1.06,
    injuryFactor: 1.0,
